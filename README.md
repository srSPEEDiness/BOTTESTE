...
<p align="center">
  <img src="https://raw.githubusercontent.com/srSPEEDiness/BOTTESTE/main/banner.jpg" height="600px"/>
</p>
...
```
rm -rf BOT > /dev/null 2>&1 && bash <(wget -qO- https://raw.githubusercontent.com/srSPEEDiness/BOTTESTE/main/inst-botteste)
```
